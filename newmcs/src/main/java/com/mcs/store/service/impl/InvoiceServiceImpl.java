...
public class InvoiceServiceImpl implements InvoiceService {
    ...
    @Override
    public InvoiceDetailGetDataModel getInvoiceDetail(Long invoice_id,Long invoice_detail_id)
    {
         return new InvoiceDetailGetDataModel(invoiceDetailConverter.entityToModel(invoiceDetailRepository.findById(invoice_id,invoice_detail_id).get()));
    }
    ...
    @Override
    public void deleteInvoiceDetail(Long invoice_id,Long invoice_detail_id)    {
          invoiceDetailRepository.deleteById(invoice_id,invoice_detail_id);
    }    
