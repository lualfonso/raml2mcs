...
public class InvoiceDetailConverter {
    ...
    public InvoiceDetailGetModel entityToModel(InvoiceDetailBean entity) {
        ...
        model.setInvoiceDetailInvoiceId(entity.getId());        
        model.setInvoiceDetailId(entity.getId());        
        model.setInvoiceDetailAmount(entity.getAmount());        
        return model;
    }
    ...
    public InvoiceDetailBean modelToEntity(InvoiceDetailPostModel model) {
        ...
        entity.setId(model.getInvoiceDetailInvoiceId()); 
        entity.setId(model.getInvoiceDetailId()); 
        entity.setAmount(model.getInvoiceDetailAmount()); 
        return entity;
    }
