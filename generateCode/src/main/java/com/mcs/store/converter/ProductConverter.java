...
public class ProductConverter {
    ...
    public ProductGetModel entityToModel(ProductBean entity) {
        ...
        model.setProductId(entity.getId());        
        model.setProductDescription(entity.getDescription());        
        return model;
    }
    ...
    public ProductBean modelToEntity(ProductPostModel model) {
        ...
        entity.setId(model.getProductId()); 
        entity.setDescription(model.getProductDescription()); 
        return entity;
    }
